...
OBJC_OBJ  = $(BUILD_DIR)/VirtualDisplay.o $(BUILD_DIR)/CGSModeHelper.o $(BUILD_DIR)/CGSDisplayHelper.o
...
$(BUILD_DIR)/CGSDisplayHelper.o: Sources/CGSDisplayHelper.m Sources/CGSDisplayHelper.h
	@mkdir -p $(BUILD_DIR)
	clang -c Sources/CGSDisplayHelper.m -o $@ -fobjc-arc -fmodules
